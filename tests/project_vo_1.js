...
// fonvtion pour l'affichage les livres
function affichager_livers(livres){
    ...
    do{
        ...
        switch(operations){
            ...
            case 5:
                ...
                if(livre_cherecher){
                    console.log("--------------------------------------------------\n le livre tu charche : \n--------------------------------------------------");
                    affichager_livers([livre_cherecher]);
                }else{
...
//  Gestion des abonnés
// afficher abonnes 
function affichager_livers(abonnes){
...
function gestion_abonnes(abonnes){
    ...
    do{
        ...
        switch(choix){
            case 1 :
                let abonne = ajouterAbonne()
                abonnes.push(abonne);
                console.log("Abonné ajouté avec succès !");
                break
            case 2 :
                affichager_livers(abonnes)
                break
            case 3 :
                console.log("--------------------------------------------------");
                break
    ...
    do{
        ...
        switch(choix){
            ...
            case 5:
                ...
                let choixEmprunt = Number(prompt("Quelle est votre choix :"));
                console.log("--------------------------------------------------\n");
                switch(choixEmprunt){
                    case 1:
                        enregistrer_emprunt(abonnes, livres, emprunts);
